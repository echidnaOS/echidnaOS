...
void cowsay_cmd(char** s_argv, int s_argc) {
    ...
    else if (!strcmp("bcowsay", s_argv[0]))
        puts(
            "\n        \\   ^__^\n"
            "         \\  (==)\\_______\n"
            "            (__)\\       )\\/\\\n"
    ...
    else if (!strcmp("dcowsay", s_argv[0]))
        puts(
            "\n        \\   ^__^\n"
            "         \\  (XX)\\_______\n"
            "            (__)\\       )\\/\\\n"
    ...
    else if (!strcmp("gcowsay", s_argv[0]))
        puts(
            "\n        \\   ^__^\n"
            "         \\  ($$)\\_______\n"
            "            (__)\\       )\\/\\\n"
    ...
    else if (!strcmp("pcowsay", s_argv[0]))
        puts(
            "\n        \\   ^__^\n"
            "         \\  (@@)\\_______\n"
            "            (__)\\       )\\/\\\n"
    ...
    else if (!strcmp("scowsay", s_argv[0]))
        puts(
            "\n        \\   ^__^\n"
            "         \\  (**)\\_______\n"
            "            (__)\\       )\\/\\\n"
    ...
    else if (!strcmp("tcowsay", s_argv[0]))
        puts(
            "\n        \\   ^__^\n"
            "         \\  (--)\\_______\n"
            "            (__)\\       )\\/\\\n"
